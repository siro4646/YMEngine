...
namespace ym
{
	...
	public:
		...
		bool Init(Device *pDev, size_t size, size_t stride, BufferUsage::Type type, bool isDynamic, bool isUAV);
		bool Init(Device *pDev, size_t size, size_t stride, BufferUsage::Type type, D3D12_RESOURCE_STATES initialState, bool isDynamic, bool isUAV);
		void Destroy();
