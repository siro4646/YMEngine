...
namespace ym
{
	...
	public:
		...
		bool Init(Device *pDev, const RootSignatureDesc &desc);
		bool Init(Device *pDev, const D3D12_ROOT_SIGNATURE_DESC &desc);
		bool Init(Device *pDev, const D3D12_VERSIONED_ROOT_SIGNATURE_DESC &desc);
		bool Init(Device *pDev, Shader *vs, Shader *ps, Shader *gs, Shader *hs, Shader *ds);
		bool Init(Device *pDev, Shader *as, Shader *ms, Shader *ps);
		bool Init(Device *pDev, Shader *cs);
		bool InitWithBindless(Device *pDev, Shader *vs, Shader *ps, Shader *gs, Shader *hs, Shader *ds, const RootBindlessInfo *bindlessInfos, u32 bindlessCount);
		bool InitWithBindless(Device *pDev, Shader *as, Shader *ms, Shader *ps, const RootBindlessInfo *bindlessInfos, u32 bindlessCount);
		bool InitWithBindless(Device *pDev, Shader *cs, const RootBindlessInfo *bindlessInfos, u32 bindlessCount);
		void Destroy();
