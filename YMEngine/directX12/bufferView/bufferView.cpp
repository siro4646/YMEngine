...
{
	//----
	bool ConstantBufferView::Init(Device *pDev, Buffer *pBuffer, size_t offset, size_t size)
	{
	...
	//----
	bool VertexBufferView::Init(Device *pDev, Buffer *pBuffer, size_t offset, size_t size)
	{
		if (!pBuffer)
		{
			return false;
	...
	bool VertexBufferView::Init(Device *pDev, Buffer *pBuffer, size_t offset, size_t size, size_t stride)
	{
		if (!pBuffer)
		{
			return false;
	...
	//----
	bool IndexBufferView::Init(Device *pDev, Buffer *pBuffer, size_t offset, size_t size)
	{
		if (!pBuffer)
		{
			return false;
	...
	bool IndexBufferView::Init(Device *pDev, Buffer *pBuffer, size_t offset, size_t size, size_t stride)
	{
		if (!pBuffer)
		{
			return false;
	...
	//----
	bool BufferView::Init(Device *pDev, Buffer *pBuffer, u32 firstElement, u32 numElement, u32 stride)
	{
