...
namespace ym
{
	...
	void BlurMaterial::CreateShader()
	{
		vs_->Init(device_, ShaderType::Vertex, "gausBlur");
		ps_->Init(device_, ShaderType::Pixel, "gausBlur");
	}
	void BlurMaterial::CreatePipelineState()
	{
		auto bbidx = device_->GetSwapChain().GetFrameIndex();
...
{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
	...
	void BlurMaterial::CreateShrink()
	{
