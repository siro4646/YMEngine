...
namespace ym
{
	...
	void GrayScaleMaterial::Uninit()
	{
		PostProcessMaterial::Uninit();
	}
	void GrayScaleMaterial::Update()
	{

	}
	void GrayScaleMaterial::Draw()
	{
	...
	void GrayScaleMaterial::SetMaterial()
	{
	...
	void GrayScaleMaterial::CreateShader()
	{
		vs_->Init(device_, ShaderType::Vertex, "grayScale");
		ps_->Init(device_, ShaderType::Pixel, "grayScale");
	}
	void GrayScaleMaterial::CreatePipelineState()
	{
		auto bbidx = device_->GetSwapChain().GetFrameIndex();
